...
namespace NOM
{
    ...
    public class DesktopWallpaper
    {
        ...
        public interface IDesktopWallpaper  // interface class, members of an interface are abstract and public.
        {
            ...
            DesktopSlideshowDirection GetStatus();  // A pointer to a DESKTOP_SLIDESHOW_STATE value that, when this method returns successfully, receives one or more of the following flags.
